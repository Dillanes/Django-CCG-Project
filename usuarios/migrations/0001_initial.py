    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_login', models.DateTimeField(blank=True, null=True, verbose_name='last login')),
                ('is_superuser', models.BooleanField(default=False, help_text='Designates that this user has all permissions without explicitly assigning them.', verbose_name='superuser status')),
                ('username', models.CharField(db_index=True, max_length=45)),
                ('Correo', models.EmailField(db_index=True, max_length=255, verbose_name='Correo Electronico')),
                ('Nombre', models.CharField(blank=True, max_length=45, null=True, verbose_name='Nombre')),
                ('Apellidos', models.CharField(blank=True, max_length=90, null=True, verbose_name='Apellidos')),
                ('Genero', models.CharField(blank=True, max_length=1, null=True)),
                ('Rol', models.CharField(max_length=15)),
                ('fechaCreacion', models.DateTimeField(blank=True, editable=False, null=True)),
                ('is_active', models.BooleanField(default=True)),
                ('is_staff', models.BooleanField(default=False)),
